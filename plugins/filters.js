...
const array = ['Kalippanser','help','achodaa','Aarulle','Aysheri','Ayo','Da','Ee','Enthada','Hi','Line','Love','Ok','poda','Va','Vannu','umma']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
